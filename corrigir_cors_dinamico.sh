...
echo "🔧 CORREÇÃO CORS DINÂMICO"
echo "========================"
echo "Corrigindo erro: 'multiple values but only one is allowed'"
echo ""

# Backup da configuração atual
BACKUP_FILE="/etc/nginx/sites-available/desfollow.backup.cors-fix.$(date +%Y%m%d_%H%M%S)"
...
# Configuração corrigida - CORS dinâmico baseado no Origin
sudo tee /etc/nginx/sites-available/desfollow > /dev/null << 'EOF'
# ========================================
# CONFIGURAÇÃO NGINX - DESFOLLOW CORS CORRIGIDO
# ========================================
...
# API HTTPS - CORS DINÂMICO CORRIGIDO
server {
    ...
    # 🚀 CORS DINÂMICO: Mapear Origin para valor único
    map $http_origin $cors_origin {
        default "";
        "~^https://desfollow\.com\.br$" "https://desfollow.com.br";
        "~^https://www\.desfollow\.com\.br$" "https://www.desfollow.com.br";
        "~^http://desfollow\.com\.br$" "http://desfollow.com.br";
        "~^http://www\.desfollow\.com\.br$" "http://www.desfollow.com.br";
    }
    ...
    location / {
        ...
        # 🚀 CORS DINÂMICO CORRIGIDO - UM VALOR POR VEZ
        add_header Access-Control-Allow-Origin $cors_origin always;
        add_header Access-Control-Allow-Methods "GET, POST, PUT, DELETE, OPTIONS" always;
        add_header Access-Control-Allow-Headers "Authorization, Content-Type, X-Requested-With" always;
        add_header Access-Control-Allow-Credentials true always;
        
        # Preflight CORS - UM VALOR POR VEZ
...
echo "✅ Configuração CORS dinâmico criada"
...
echo "🧪 Testando CORS com desfollow.com.br..."
...
echo "🧪 Testando CORS com www.desfollow.com.br..."
...
echo ""
echo "🔄 CORS DINÂMICO:"
echo "   ✅ Origin: https://desfollow.com.br → Allow-Origin: https://desfollow.com.br"
echo "   ✅ Origin: https://www.desfollow.com.br → Allow-Origin: https://www.desfollow.com.br"
echo "   ✅ Origin: http://desfollow.com.br → Allow-Origin: http://desfollow.com.br"
echo "   ✅ Origin: http://www.desfollow.com.br → Allow-Origin: http://www.desfollow.com.br"
echo ""
echo "⚙️ MELHORIAS MANTIDAS:"
echo "   ✅ Timeout API: 300s (5 minutos)"
echo "   ✅ CORS: Dinâmico (um valor por vez)"
echo "   ✅ Proxy buffering: Desabilitado"
echo ""
echo "📜 Backup salvo em: $BACKUP_FILE"
echo ""
echo "🚀 CORS corrigido! Problema 'multiple values' resolvido."