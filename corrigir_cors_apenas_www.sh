...
echo "🔧 CORREÇÃO CORS APENAS WWW"
echo "============================="
echo "Corrigindo CORS para aceitar apenas https://www.desfollow.com.br"
echo ""

# Backup da configuração atual
BACKUP_FILE="/etc/nginx/sites-available/desfollow.backup.cors-apenas-www.$(date +%Y%m%d_%H%M%S)"
...
echo ""
echo "📋 Criando configuração nginx com CORS apenas www..."

# Configuração nginx com CORS apenas www
sudo tee /etc/nginx/sites-available/desfollow > /dev/null << 'EOF'
# ========================================
# CONFIGURAÇÃO NGINX - CORS APENAS WWW
# ========================================
# Frontend: desfollow.com.br + www.desfollow.com.br (HTTP - SSL via Hostinger)
# API: api.desfollow.com.br (HTTPS)
# CORS: Apenas https://www.desfollow.com.br
# ========================================
...
server {
    ...
    location / {
        ...
        # 🚀 CORS APENAS WWW - Um valor único
    ...
    # Preflight OPTIONS - CORS apenas www
    location = /api/scan {
...
echo "✅ Configuração nginx com CORS apenas www criada"
...
if pgrep -f "uvicorn\|gunicorn" > /dev/null; then
    ...
    echo "📋 Verificando systemctl status..."
    sudo systemctl status desfollow --no-pager
fi

echo ""
echo "📋 Testando CORS apenas www..."

sleep 3

echo "🧪 Testando CORS com https://www.desfollow.com.br..."
CORS_TEST=$(curl -s -H "Origin: https://www.desfollow.com.br" -H "Access-Control-Request-Method: POST" -X OPTIONS "https://api.desfollow.com.br/api/scan" -I | grep "Access-Control-Allow-Origin")
echo "   Origin: https://www.desfollow.com.br"
echo "   Response: $CORS_TEST"

echo ""
echo "✅ CORS APENAS WWW CONFIGURADO!"
echo ""
...
echo ""
echo "🔄 CORS APENAS WWW:"
echo "   ✅ Aceita: https://www.desfollow.com.br (único valor)"
echo "   ✅ Backend: SEM CORS (apenas nginx)"
echo ""
echo "📜 Backup salvo em: $BACKUP_FILE"
echo ""
echo "🚀 CORS APENAS WWW FUNCIONANDO!" 