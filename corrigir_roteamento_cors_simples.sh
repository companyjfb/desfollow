...
echo "🔧 CORREÇÃO ROTEAMENTO + CORS SIMPLES"
echo "====================================="
echo "Verificando certificados existentes e corrigindo roteamento"
echo ""

# Backup da configuração atual
BACKUP_FILE="/etc/nginx/sites-available/desfollow.backup.simples.$(date +%Y%m%d_%H%M%S)"
...
echo ""
echo "📋 Criando configuração nginx baseada nos certificados existentes..."

# Configuração nginx baseada nos certificados existentes
...
# ========================================
# CONFIGURAÇÃO NGINX - AMBOS CERTIFICADOS
# ========================================
...
EOF
    ...
    ./corrigir_roteamento_cors_simples.sh
    exit 0
fi

echo "✅ Configuração nginx criada baseada nos certificados existentes"
