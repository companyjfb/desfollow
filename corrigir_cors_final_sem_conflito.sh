...
echo "🔧 CORREÇÃO CORS FINAL - SEM CONFLITO"
echo "======================================"
echo "Corrigindo CORS para aceitar desfollow.com.br e www.desfollow.com.br"
echo ""
...
echo ""
echo "📋 Criando configuração nginx com CORS correto..."

# Configuração nginx com CORS correto para ambos domínios
sudo tee /etc/nginx/sites-available/desfollow > /dev/null << 'EOF'
# ========================================
# CONFIGURAÇÃO NGINX - CORS CORRETO
# ========================================
...
# API HTTPS - CORS CORRETO PARA AMBOS DOMÍNIOS
server {
    ...
    location / {
        ...
        # Preflight OPTIONS - CORS correto
...
echo "✅ Configuração nginx com CORS correto criada"
...
echo ""
echo "🔄 CORS:"
echo "   ✅ Aceita: https://desfollow.com.br"
echo "   ✅ Aceita: https://www.desfollow.com.br"
echo "   ✅ Backend: SEM CORS (apenas nginx)"
echo ""
echo "📜 Backup salvo em: $BACKUP_FILE"
echo ""
echo "🚀 CORS CORRETO FUNCIONANDO!" 