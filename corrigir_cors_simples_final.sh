...
echo "🔧 CORREÇÃO CORS SIMPLES FINAL"
echo "==============================="
echo "Corrigindo CORS com configuração simples e compatível"
echo ""

# Backup da configuração atual
BACKUP_FILE="/etc/nginx/sites-available/desfollow.backup.cors-simples.$(date +%Y%m%d_%H%M%S)"
...
server {
    ...
    location / {
        ...
        # 🚀 CORS SIMPLES - Aceita ambos domínios
...
echo "✅ Configuração nginx com CORS simples criada"
...
echo ""
echo "🔄 CORS SIMPLES:"
echo "   ✅ Aceita: https://desfollow.com.br (configuração fixa)"
echo "   ✅ Backend: SEM CORS (apenas nginx)"
echo ""
echo "📜 Backup salvo em: $BACKUP_FILE"
echo ""
echo "🚀 CORS SIMPLES FUNCIONANDO!" 