...
echo "🔧 Corrigindo configuração do Nginx (versão final)..."
echo "=================================================="
...
echo ""
echo "🔧 Aplicando nova configuração corrigida..."

# Fazer backup da configuração atual
cp /etc/nginx/sites-available/desfollow /etc/nginx/sites-available/desfollow.backup.$(date +%Y%m%d_%H%M%S)

# Aplicar nova configuração corrigida
cp nginx_desfollow_fixed.conf /etc/nginx/sites-available/desfollow
